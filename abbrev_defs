...
(define-abbrev-table 'global-abbrev-table
  '(
    ("pno" "07944.683.642" nil 0)
    ("teh" "the " nil 0)
    ("ahve" "have" nil 0)
    ("awalys" "always" nill 1)
    ("awya" "away" nil 0)
    ("aywa" "away" nil 0)
    ("bakc" "back" nil 0)
    ("becasue" "because" nil 0)
    ("beginging" "beginning" nill 1)
    ("echaustive" "exhaustive" nil 1)
    ("magnificient" "magnificent" nil 1)
    ("nkow" "know" nil 1)
    ("pidgeon" "pigeon" nil 1)
    ("rwite" "write" nil 0)
    ("sovreign" "sovereign" nill 1)
    ("gn " "ng" nill 1)
    ("useage" "usage" nil 1)
   ))
